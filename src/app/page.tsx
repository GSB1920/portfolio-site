          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="slide-in-left">
              <div className="glass-card rounded-3xl p-8 h-full">
                ...
                <p className="text-white/80 text-lg leading-relaxed mb-6">
                  I&apos;m a passionate full-stack engineer with 3+ years of experience building 
                  scalable web applications and SaaS platforms. My journey started with curiosity 
                  about how digital products work, and it has evolved into a deep love for creating 
                  solutions that make a real impact.
                </p>
                <p className="text-white/80 text-lg leading-relaxed mb-8">
                  From founding NoxAlgo LLP to working on low-code platforms, I&apos;ve learned that 
                  great software is not just about code—it&apos;s about understanding user needs and 
            ...
            <div className="slide-in-right space-y-6">
              <div className="glass-card rounded-2xl p-6 hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-white/70">Clean, maintainable code that stands the test of time.</p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-6 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-xl font-bold">Team Player</h4>
                </div>
                <p className="text-white/70">Collaboration and knowledge sharing drive great products.</p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-6 hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-white/70">Always exploring new technologies and better solutions.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="scale-in reveal-delay-1 glass-card rounded-3xl p-8 hover:scale-105 transition-all duration-300">
              ...
              <div className="tech-grid">
                ...
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Tailwind</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">React Native</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Sass</div>
              </div>
            </div>
            ...
            <div className="scale-in reveal-delay-2 glass-card rounded-3xl p-8 hover:scale-105 transition-all duration-300">
              ...
              <div className="tech-grid">
                ...
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">REST API</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">GraphQL</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Prisma</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Mongoose</div>
              </div>
            </div>
            ...
            <div className="scale-in reveal-delay-3 glass-card rounded-3xl p-8 hover:scale-105 transition-all duration-300">
              ...
              <div className="tech-grid">
                ...
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">MySQL</div>
                ...
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Supabase</div>
              </div>
            </div>
            ...
            <div className="scale-in reveal-delay-4 glass-card rounded-3xl p-8 hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-6 text-center gradient-text">DevOps</h3>
              <div className="tech-grid">
                ...
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Vercel</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">CI/CD</div>
                <div className="glass text-center py-3 px-2 rounded-lg text-sm font-mono">Git</div>
            ...
            <div className="rotate-in glass-card rounded-3xl p-8 hover:scale-[1.02] transition-all duration-300">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                <div className="mb-4 lg:mb-0">
                  <h3 className="text-3xl font-bold gradient-text mb-2">Founder / Developer</h3>
                  <p className="text-2xl font-semibold text-[#00d4ff] mb-2">NoxAlgo LLP</p>
                  <p className="text-white/60 font-mono">Aug 2024 – Present</p>
                </div>
                <div className="glass px-4 py-2 rounded-xl">
                  <span className="text-[#10b981] font-semibold">Current Role</span>
                </div>
              </div>
            ...
            <div className="rotate-in reveal-delay-1 glass-card rounded-3xl p-8 hover:scale-[1.02] transition-all duration-300">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                <div className="mb-4 lg:mb-0">
                  ...
                  <p className="text-white/60 font-mono">Jul 2021 – Jun 2024</p>
                </div>
                <div className="glass px-4 py-2 rounded-xl">
                  <span className="text-[#8b5cf6] font-semibold">3 Years</span>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">gaurav@example.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">linkedin.com/in/gaurav</p>
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6 mb-8">
              <a href="#" className="w-12 h-12 glass rounded-2xl flex items-center justify-center hover:scale-110 transition-transform duration-300">
